            ...
            FadeSlide(
              ...
              child: Center(
                child: Container(
                  ...
                  child: Icon(Iconsax.lock, size: width * .10, color: primary),
                ),
              ),
            ),
              ...
              child: Obx(
                () => SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: controller.isSendingCode.value ? null : next,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            FadeSlide(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: primary.withOpacity(.15)),
                  boxShadow: [
                    BoxShadow(color: primary.withOpacity(.08), blurRadius: 35),
                  ],
                ),
                child: Icon(
            ...
            /// ───────── OTP FIELDS
            FadeSlide(delayMs: 450, child: _OtpFields(controller: controller)),
            ...
            FadeSlide(
              ...
              child: Obx(
                () => SizedBox(
                  ...
                  height: 58,
                  child: ElevatedButton(
                    onPressed: controller.isVerifyingCode.value ? null : next,
                    style: ElevatedButton.styleFrom(
                      elevation: 0,
                      backgroundColor: primary,
                      shape: RoundedRectangleBorder(
                    ...
                    child: controller.isVerifyingCode.value
                        ? const SizedBox(
                            width: 22,
                            height: 22,
                            child: CircularProgressIndicator(
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: List.generate(
        6,
        (index) => _OtpBox(index: index, width: width, controller: controller),
      ),
    );
  }
}
