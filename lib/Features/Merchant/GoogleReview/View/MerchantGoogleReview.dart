...
import 'package:vclub/Features/Merchant/GoogleReview/View/Widgets/ReviewRewards.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GoogleReviewsStatsColumn(),
                  SizedBox(height: size.height * 0.02),
                  FadeSlide(delayMs: 400, child: GoogleReviewLinkCard()),
                  SizedBox(height: size.height * 0.02),
                  FadeSlide(delayMs: 450, child: RewardAfterReviewCard()),
                  SizedBox(height: size.height * 0.02),
                  FadeSlide(
                    delayMs: 500,
                    child: SizedBox(
