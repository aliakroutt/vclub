// ─────────────────────────────────────────────────────────────
//  Notification button with red badge (Merchant)
// ─────────────────────────────────────────────────────────────
...
class NotificationButtonMerchant extends StatefulWidget {
  final bool isDark;
  final VoidCallback onTap;

  const NotificationButtonMerchant({
    super.key,
  ...
  @override
  State<NotificationButtonMerchant> createState() => NotificationButtonMerchantState();
}

class NotificationButtonMerchantState extends State<NotificationButtonMerchant>
