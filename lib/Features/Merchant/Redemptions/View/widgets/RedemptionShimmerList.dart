...
class RedemptionShimmerList extends StatelessWidget {
  const RedemptionShimmerList({super.key});
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(),
              ShimmerBox(width: 70, height: 20, borderRadius: BorderRadius.circular(9)),
            ],
          ),
        ],
      ),
