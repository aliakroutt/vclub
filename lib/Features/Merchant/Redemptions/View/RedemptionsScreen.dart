            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Iconsax.receipt_2_1, size: 40, color: AppColors.primary.withOpacity(.7)),
                ),
                const SizedBox(height: 24),
                AppText("redemptions_merchant".tr, fontSize: 17, fontWeight: FontWeight.w800, textAlign: TextAlign.center),
