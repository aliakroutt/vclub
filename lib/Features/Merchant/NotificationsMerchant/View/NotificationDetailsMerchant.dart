...
class NotificationDetailsMerchant extends StatefulWidget {
  final MerchantNotificationModel notification;

  const NotificationDetailsMerchant({super.key, required this.notification});

  @override
  State<NotificationDetailsMerchant> createState() =>
      _NotificationDetailsMerchantState();
}

class _NotificationDetailsMerchantState
    extends State<NotificationDetailsMerchant> {
  final MerchantNotificationsListController controller =
