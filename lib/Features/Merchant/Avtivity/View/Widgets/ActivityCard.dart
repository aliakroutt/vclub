...
import 'ActivityDetailSheet.dart';
import 'ActivityMeta.dart';

class ActivityCard extends StatelessWidget {
  final MerchantActivityItem item;
  final int index;

  const ActivityCard({super.key, required this.item, this.index = 0});
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // ── row 1: icon, title/subtitle, arrow ──
                  Row(
