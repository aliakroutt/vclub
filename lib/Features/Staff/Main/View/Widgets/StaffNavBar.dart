...
class _StaffNavBarState extends State<StaffNavBar>
  ...
  Widget build(BuildContext context) {
    ...
    final pillW = width > 600 ? width * 0.5 : width * 0.72;
    final itemSize = width > 600 ? 54.0 : 50.0;
...
// ─── Glass pill container (3 slots: Activity | [FAB gap] | Profile) ──────────
class _StaffGlassPill extends StatelessWidget {
  final int selectedIndex;
...
// ─── Scan / close FAB (open/close state, matches merchant behavior) ─────────
class _StaffScanFab extends StatefulWidget {
  final double size;
  final double iconSize;
  final bool isOpen;
  ...
  @override
  State<_StaffScanFab> createState() => _StaffScanFabState();
}

class _StaffScanFabState extends State<_StaffScanFab> with SingleTickerProviderStateMixin {
...
// ─── Nav item ─────────────────────────────────────────────────────────────────
class _StaffNavItem extends StatefulWidget {
  final IconData icon;
  ...
  @override
  State<_StaffNavItem> createState() => _StaffNavItemState();
}

class _StaffNavItemState extends State<_StaffNavItem> with SingleTickerProviderStateMixin {
  late final AnimationController _ctrl = AnimationController(
    vsync: this,
  ...
  @override
  void didUpdateWidget(_StaffNavItem old) {
