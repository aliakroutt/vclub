...
import 'package:vclub/Features/Auth/Services/DeleteAccountService.dart';
...
import 'package:vclub/Features/Client/MyProfile/View/Widgets/DeleteAccountSheet.dart';
    ...
    showDeleteAccountSheet(
      onConfirm: () async {
        final success = await DeleteAccountService.deleteAccount(
          resetControllers: [
            safeReset<ClientDashboardController>(
              () => dashcontroller.resetControllerData(),
            ),
            safeReset<ClientCardsController>(
              () => cardscontroller.resetControllerData(),
            ),
            safeReset<NotificationsController>(
              () => notifcontroller.resetNotifications(),
            ),
            safeReset<CardsController>(
              () => CardsController.to.resetControllerData(),
            ),
            safeReset<FortuneWheelController>(
              () => FortuneWheelController.to.resetControllerData(),
            ),
            safeReset<GoogleReviewController>(
              () => GoogleReviewController.to.resetControllerData(),
            ),
          ],
        );

        if (!success) {
          AppSnackBar.error("delete_account_failed".tr);
        }
      },
    );
  }
